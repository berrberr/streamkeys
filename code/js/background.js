...
(function () {
  ...
  var getPlayingTabs = function (tabs) {
    return _.filter(tabs, function (tab) {
      return (
        Object.prototype.hasOwnProperty.call(tabStates, tab.id) &&
  ...
  var updateMPRISState = function (stateData, tab) {
    if (stateData === null) {
      ...
      var metadata = {
        ...
        "mpris:length":
          hmsToSecondsOnly((stateData.totalTime || "0").trim()) * 1000000,
      };
      var args = [
        {
          ...
          Metadata: metadata,
          Position:
            hmsToSecondsOnly((stateData.currentTime || "0").trim()) * 1000000,
        },
      ];
  ...
  chrome.storage.sync.get(function (obj) {
    if (
      Object.prototype.hasOwnProperty.call(obj, "hotkey-use_mpris") &&
      obj["hotkey-use_mpris"]
    ) {
      if (!connections) {
        connections += 1;
        ...
        chrome.tabs.onActivated.addListener(function (activeInfo) {
          if (
            Object.prototype.hasOwnProperty.call(tabStates, activeInfo.tabId)
          ) {
            handleStateData(updateMPRISState);
          }
        });
