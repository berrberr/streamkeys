...
(function () {
  ...
  function Sitelist(sites) {
    ...
    this.sites = sites || {
      ...
      bbc: {
        ...
        controller: "BBCRadioController.js",
      },
      "be-at": {
        name: "BE-AT.TV",
        url: "https://be-at.tv",
        controller: "BeAtTvController.js",
      },
      beatport: { name: "Beatport", url: "https://www.beatport.com" },
      brain: {
        name: "BrainFM",
        url: "http://brain.fm",
        controller: "BrainFMController.js",
      },
      castbox: {
        name: "Castbox",
        url: "https://castbox.fm",
        controller: "CastboxController.js",
      },
      "cloud.caster": {
        name: "Cloud Caster",
        url: "http://cloud-caster.com",
        controller: "CloudCasterController.js",
        alias: ["cloud-caster"],
      },
      coderadio: {
        name: "Code Radio",
        url: "https://coderadio.freecodecamp.org/",
        controller: "CodeRadioController.js",
      },
      coursera: { name: "Coursera", url: "http://www.coursera.org" },
      crave: {
        name: "Crave",
        url: "https://www.crave.ca",
        controller: "CraveController.js",
      },
      ...
      duckburgradio: {
        ...
        controller: "DuckburgRadioController.js",
        alias: ["radio-mb"],
      },
      ...
      embedded: {
        ...
        url: null,
        controller: "EmbeddedElementController.js",
      },
      emby: { name: "Emby", url: "http://app.emby.media" },
      feedly: { name: "Feedly", url: "http://www.feedly.com" },
      focusatwill: {
        name: "focusatwill",
        url: "http://www.focusatwill.com",
        controller: "FocusatwillController.js",
      },
      ...
      "play.google": {
        ...
        controller: "GoogleMusicController.js",
      },
      "podcasts.google": {
        name: "Google Podcasts",
        url: "http://podcasts.google.com",
        controller: "GooglePodcastsController.js",
      },
      ...
      jovemnerd: {
        ...
        controller: "JovemNerdController.js",
      },
      ...
      last: {
        ...
        controller: "LastfmController.js",
        alias: ["lastfm"],
      },
      "lifestore-flat": {
        name: "Hofer life music",
        url: "https://app.lifestore-flat.at",
        controller: "HoferLifeMusicController.js",
      },
      listenonrepeat: {
        name: "ListenOnRepeat",
        url: "http://www.listenonrepeat.com",
      },
      logitechmediaserver: {
        name: "LogitechMediaServer",
        url: "http://mysqueezebox.com",
        controller: "LogitechMediaServerController.js",
        alias: ["mysqueezebox"],
      },
      ...
      "music.163": {
        ...
        controller: "163Controller.js",
      },
      "music.microsoft": {
        name: "Microsoft Groove",
        url: "http://music.microsoft.com",
        controller: "MicrosoftController.js",
      },
      "music.zacharyseguin": {
        name: "Zachary Seguin Music",
        url: "https://music.zacharyseguin.ca",
        controller: "MusicKitJsController.js",
      },
      musicforprogramming: {
        name: "Music for Programming",
        url: "https://musicforprogramming.net",
        controller: "MusicForProgrammingController.js",
      },
      mycloudplayers: {
        name: "My Cloud Player",
        url: "http://www.mycloudplayers.com",
      },
      ...
      "music.naver": {
        ...
        controller: "NaverMusicController.js",
      },
      napster: {
        name: "Napster",
        url: "https://app.napster.com",
        controller: "NapsterController.js",
      },
      netflix: { name: "Netflix", url: "http://www.netflix.com" },
      noise: {
        name: "NoiseSupply",
        url: "http://noise.supply",
        controller: "NoiseSupplyController.js",
      },
      noisli: {
        name: "Noisli",
        url: "http://noisli.com",
        controller: "NoisliController.js",
      },
      noonpacific: { name: "Noon Pacific", url: "http://www.noonpacific.com" },
      "www.npr": {
        name: "NPR Player",
        url: "http://www.npr.org",
        controller: "NprNewsController.js",
      },
      ...
      phishjustjams: {
        name: "Phish Just Jams",
        url: "http://phishjustjams.com",
      },
      player: {
        name: "Player.fm",
        url: "http://player.fm",
        controller: "PlayerFmController.js",
        blacklist: [
          "player.spotify",
          "reddit.music.player.il",
      ...
      "music.qq": {
        ...
        controller: "QQController.js",
        alias: ["y.qq.com/portal/player.html"],
      },
      radioparadise: {
        name: "RadioParadise",
      ...
      "reddit.music.player.il": {
        ...
        url: "http://reddit.music.player.il.ly",
        controller: "RedditMusicPlayerController.js",
        alias: ["reddit.musicplayer"],
      },
      reverbnation: {
        name: "Reverb Nation",
      ...
      jiosaavn: {
        ...
        controller: "JioSaavnController.js",
      },
      ...
      streamelements: {
        name: "StreamElements",
        url: "https://streamelements.com/dashboard/songrequest/general",
      },
      streamsquid: { name: "StreamSquid", url: "http://streamsquid.com/" },
      subsonic: { name: "Subsonic", url: "http://www.subsonic.org" },
      synology: {
        name: "Synology Audio Station",
        url: "https://www.synology.me",
        controller: "SynologyAudioStationController.js",
      },
      telegram: {
        name: "Telegram Web",
        url: "https://evgeny-nadymov.github.io/telegram-react/",
        controller: "TelegramReactController.js",
        alias: ["evgeny-nadymov", "telegram-react"],
      },
      tidal: {
        name: "Tidal",
      ...
      "music.yandex": {
        ...
        controller: "YandexController.js",
      },
      "radio.yandex": {
        name: "Yandex Radio",
        url: "http://radio.yandex.ru",
        controller: "YandexRadioController.js",
      },
      youarelistening: {
        name: "YouAreListening.to",
        url: "http://www.youarelistening.to",
        controller: "YouarelisteningtoController.js",
      },
      xiami: { name: "Xiami", url: "http://www.xiami.com" },
      "music.youtube": {
        name: "YouTube Music",
        url: "https://music.youtube.com",
        controller: "YoutubeMusicController.js",
      },
      youtube: { name: "YouTube", url: "http://www.youtube.com" },
      youzeek: { name: "YOUZEEK", url: "http://www.youzeek.com" },
      zonga: {
        name: "Zonga",
        url: "http://asculta.zonga.ro",
        controller: "ZongaController.js",
      },
    };
  ...
  Sitelist.prototype.loadSettings = function () {
    ...
    chrome.storage.sync.get(function (obj) {
      ...
      var version =
        typeof obj["hotkey-storage-version"] === "undefined"
          ? 0
          : obj["hotkey-storage-version"];
        ...
        var siteObj =
          version === 0
            ...
            ? // Validate enabled/priority values in case of migration problems
              {
                enabled: _.isBoolean(obj["hotkey-sites"][siteKey].enabled)
                  ? obj["hotkey-sites"][siteKey].enabled
                  : true,
                priority: _.isNumber(obj["hotkey-sites"][siteKey].priority)
                  ? obj["hotkey-sites"][siteKey].priority
                  : 1,
                alias: _.isArray(obj["hotkey-sites"][siteKey].alias)
                  ? obj["hotkey-sites"][siteKey].alias
                  : [],
                showNotifications: _.isBoolean(
                  obj["hotkey-sites"][siteKey].showNotifications
                )
                  ? obj["hotkey-sites"][siteKey].showNotifications
                  : false,
              }
      ...
      if (
        !Object.prototype.hasOwnProperty.call(obj, "hotkey-youtube_restart")
      ) {
  ...
  Sitelist.prototype.setSiteState = function (siteKey, value) {
    ...
    var promise = new Promise(function (resolve) {
      ...
      that.setSiteStorage(siteKey, value).then(
        function () {
          resolve();
        },
        function () {
    ...
    var promise = new Promise(function (resolve) {
      ...
      chrome.tabs.query({}, function (tabs) {
        ...
        if (musicTabs.length > 0) {
          var maxPriority = _.sortBy(musicTabs, function (tab) {
            return tab.priority * -1;
          })[0].priority;

          musicTabs = _.map(
            _.filter(musicTabs, function (tab) {
              return tab.priority == maxPriority;
            }),
            function (musicTab) {
              return musicTab.tab;
            }
