...
(function () {
  ...
  BaseController.prototype.doc = function () {
    ...
    if (this.selectors.iframe) {
      if (document.querySelector(this.selectors.iframe)) {
        if (
          document
            .querySelector(this.selectors.iframe)
            .tagName.indexOf("FRAME") > -1
        ) {
          returnDoc = document.querySelector(this.selectors.iframe)
  ...
  BaseController.prototype.getStateData = function () {
    return {
      song:
        this.getSongData(this.selectors.song) === null
          ? null
          : this.getSongData(this.selectors.song).replace(/\s+/g, " "),
      artist:
        this.getSongData(this.selectors.artist) === null
          ? null
          : this.getSongData(this.selectors.artist).replace(/\s+/g, " "),
      album:
        this.getSongData(this.selectors.album) === null
          ? null
          : this.getSongData(this.selectors.album).replace(/\s+/g, " "),
      ...
      siteName:
        this.siteName == null ? null : this.siteName.replace(/\s+/g, " "),
      canDislike: !!(
